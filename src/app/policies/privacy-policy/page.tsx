      ...
      <div className="container mx-auto px-8 pt-[120px] pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How We Collect and Use Your Personal Information</h2>
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What Personal Information We Collect</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
              </p>

              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-8">Information We Collect Directly from You</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-8">Information We Collect about Your Usage</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-8">Information We Obtain from Third Parties</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How We Use Your Personal Information</h2>
              
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-6">Providing Products and Services.</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-6">Marketing and Advertising.</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-6">Security and Fraud Prevention.</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 mt-6">Communicating with You and Service Improvement.</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mt-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How We Disclose Personal Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="overflow-x-auto mt-6">
                <table className="min-w-full border border-gray-300">
                  <thead className="bg-gray-100">
                    <tr>
                      <th className="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Category</th>
                      <th className="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Categories of Recipients</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Identifiers such as basic contact details and certain order and account information</td>
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Commercial information such as order information, shopping information and customer support information</td>
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Business and marketing partners</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Internet or other similar network activity, such as Usage Data</td>
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Affiliates</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-3 text-gray-700">Geolocation data such as locations determined by an IP address or other technical measures</td>
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Third Party Websites and Links</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Children's Data</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Security and Retention of Your Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Complaints</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">International Users</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mt-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:supp.altf4@gmail.com" className="text-blue-600 hover:text-blue-800 underline">supp.altf4@gmail.com</a> or contact us at Navi Mumbai
              </p>
            </section>
          </div>
        </div>
